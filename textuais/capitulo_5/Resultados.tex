...
\section{\textbf{RESULTADOS}}
    ...
    Interfaces presentes em \textit{Comunication} e \textit{Repository}
    permitem que o programador crie classes que as implementam. Tal abordagem,
    que vai de encontro com o princípio de inversão de dependência dos
    princípios SOLID, garante que há alguma base para substituição de
    componentes externos ao domínio sem alterações profundas nos internos.
