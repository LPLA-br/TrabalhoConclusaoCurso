...
\section{\textbf{INTRODUÇÃO}}
    ...
    a imaturidade técnico-metodologica firmava-se como fator propulsor da crise \cite[~p.14]{brooks1995mythical}. Apresentava-se,
    como consequências negativas da aparente inação, era proeminênte O(A):
    ...
    Engineering Conference NATO Science Committee} dentres outras.
    ...
    Tais aliçerces denominaram-se: módulos, bibliotecas e frameworks \cite{IEEEGlossary}.

    Tais peças de \textit{software} são, como várias outras, criadas para
    solucionar problemas genêricos e acabam, por vezes, criando situações em
    que lógica de negócio, principal parte da solução em desenvolvimento,
    mistura-se com soluções por ela providas causando, assim, um acoplamento
    perigoso ocasionante de dificuldades de manutenção, extenção, teste
    do software emergente \cite{evans2004domain, uncleBob2017}.

    % V. Conclusão da introdução - Pode-se evitar a dependência ?
    Problemas de dependência e acoplamento são objetos comuns de discussões
    acaloradas em comunidades de engenheiros de software e cientistas da
    computação. Inúmeros autores extendem o estado da arte neste âmbito
    em busca de uma boa solução que possa garantir meios equilibrados
    na implementação de \textit{software}. Logo projetos que empreguem
    tais metodologias em tecnologias comuns de mercado são importantes para
    reforço do conhecimento costruído.
