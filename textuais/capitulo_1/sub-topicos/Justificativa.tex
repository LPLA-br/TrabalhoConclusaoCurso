...
\subsection{\textbf{Justificativa}}
    ...
    de metodologias, técnias e ou filosofias desenvolvidas para solucionar problemas
    existentes em desenvolvendo software.
    ...
    Trata-se do emprego real do conhecimento pré-existente em prol de se chegar
    a conclusões sobre as limitações e possibilidades proporcionados pela prática.
