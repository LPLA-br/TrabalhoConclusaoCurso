...
\section{\textbf{FUNDAMENTAÇÃO TEÓRICA}}
   ...
   % consistente à pesquisa. 
    ...
    Notoriamente, ao definirmos esses pilares, percebemos que eles
    ...
    Conseguinte aos princípios, apontamos o SOLID, onde CECIL MARTIN, Robin
    \(2017\) classifica em cinco subprincípios interconectados, tais como: A
    ...
    Neste sentido, citamos o padrão \textit{Adapter} que, a princípio,
...
%   Distânciar-se mais padrões, por possui escopo muito amplo, e focar em arquiteturas.
    ...
    No que tange as arquiteturas de sistemas, apontamos que houve o aprimoramento contínuo de
    ...
    Neste sentido, seguindo a lógica desses autores, apontamos que eles tratam
