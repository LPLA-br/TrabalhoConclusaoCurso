...
\section{\textbf{FUNDAMENTAÇÃO TEÓRICA}}
   ...
   % consistente à pesquisa. 
    ...
    qualidade do \textit{software} sob o paradigma de programação orientada a
    objetos \ac{oop}.

    % orientação a objetos - pilares
    Neste sentido, antes de avançar sobre conceitos arquiteturais e de padrões
    de projetos, deve-se, primeiro, observar os fundamentos intrínsecos do
    paradigma sobre o qual dispõe-se a trabalhar.
    ...
    âmbito do desenvolvimento de \textit{software}, consiste na forma como os
    ...
    Inicialmente surgiu com o desenvolvimento da arquitetura de Von Neumann,
    onde o primeiro paradigma, o imperativo que trazia os conceitos fundamentais de estado
    ...
    Simula (1962) e Smalltalk (1972), trazem os conceitos de objeto como uma
    ...
    presentes em \citeonline{kasture2019pillars}, nos quatros pilares
    fundamentais da implementação \ac{oop} definidos como:
    ...
    Por sua vez, os princípios mais abragentes e abstratos, influenciam um
    ...
    dos princípios se baseia na: universalidade, independência de tecnologia
    ...
    classifica em cinco sub-princípios interconectados, tais como: A
...
%   Distânciar-se mais padrões, por possui escopo muito amplo, e focar em arquiteturas.
    ...
    propriedades e ideais desejadas, como apontado por \cite[p. 202]{uncleBob2017}:

    \begin{itemize}
      \item{ Arquitetura que independe de frameworks para funcionar; }
      \item{ Regras de negócio podem ser testadas sem interferência de camadas superiores ou inferiores; }
      \item{ Independência de interface de Usuário onde ela pode mudar sem interferir o resto do sistema; }
      \item{ Independência de banco de dados onde sua mudança não interfere nas regras de negócio;  }
      \item{ Independência total das regras de negócio. }
    \end{itemize}

    Notadamente o somatório dessas propriedades,levam ao desenvolvimento
    ininterrupto de conceitos, que são promovedores da separação de
    responsabilidades, principalmente em arquiteturas baseadas em camadas.
    Diante do exposto, chegou-se à conclusão universal de que todo o \textit{software}
    ...
    separa-se das demais camadas que proveem sua funcionalidade.
    ...
    um padrão majoritariamente composto de classes adaptadoras que possibilitam a separação
    ...
    de negócios sobre algumas ou todas as partes sobrelistadas.

    Apesar dos conceitos apresentados nos parágrafos anteriores aparentarem
    ser ótimos, existe, de fato, um criticismo na forma pela qual tais orientações
