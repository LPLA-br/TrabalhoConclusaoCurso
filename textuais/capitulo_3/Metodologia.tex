...
\section{\textbf{METODOLOGIA}}
    ...
    Assim, ao definir como objetivos a independência estrita do software para
    ...
    Dessa forma, partindo desta etapa metodológica comunicativa essencial
    ...
    Dado que, ao estabelecer um processo de etapas e fluxo bem definido
    segue-se, dentro deste modelo, para a etapa de planejamento e modelagem onde macro
    ...
    de domínio de negócio, encontram-se isolados de objetos do ambiente
    ...
    O sistema, de modo a atender os objetivos, possui classes que intermediam
    várias características indispensáveis à aplicação.
    ...
    onde uma e outra são empregadas simultâneamente. 

    Em suma, de modo a prosseguir em etapas posteriores ao planejamento e
    modelagem que são construção e entrega, elas desenrolar-se-ão mais
    apropriadamente sobre a seção de desenvolvimento que tratará mais
    intimamente acerca do domínio que originou as classes ditas como nucleares.
