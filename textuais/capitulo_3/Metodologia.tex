...
\section{\textbf{METODOLOGIA}}
    ...
    desenvolvida que provê interface ao usuário final. Logo sobra a escrita
    do: Domínio de negócios; Adaptador de banco de dados e Adaptador para
    comunicação usando protocolo de transporte.

    No campo das classes, em sistemas \ac{oop}, há interelações entre elas na
    forma de herança ou composição, ocorre que, em meios técnicos, discute-se
    acerca da necessidade de se priorizar uma sobre a outra
    \cite{rodriguesLenon2023}. Não obstante, o objeto deste trabalho assume uma
    abordagem mista onde uma e outra são empregadas simultâneamente de acordo
    com o que se julga mais adequado e conveniente ao contexto de implementação.
