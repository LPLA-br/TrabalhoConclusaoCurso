...
\section{\textbf{METODOLOGIA}}
    ...
    pela metodologia aqui apresentada em função dos conhecimentos úteis da engenharia
    e arquitetura de \textit{software} comum.
    ...
    Seguindo a etapa prima metodológica comunicativa, \citeonline{rogerPressman2021}
    define mais outras quatro atividades fundamentais a qualquer projeto
    ativamente desenvolvido, são elas:
