...
\section{\textbf{DESENVOLVIMENTO}}
    ...
    No tocante às dependências que são foco do experimento, o PHP possui
    ...
    %pgsql e sockets
    Ativou-se duas extensões cuja finalidade foram de encontro a
    garantir as capacidades de requisição e reposta e execução
    de transações \ac{sql}
