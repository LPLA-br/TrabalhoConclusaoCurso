...
\section{\textbf{DESENVOLVIMENTO}}
    ...
    No tocante às classes coleções supra-apresentadas, a obra
    \citeonline{goldberg1984smalltalk} foi de extrema importância na orientação
    cautelosa de se evitar que objetos como peças e insumos possuissem excesso de
    responsabilidades em manipulando matrizes de subobjetos agregados.
    ...
    Quanto ao âmbito da comunicação, não utilizou-se protocolo da de aplicação
    em redes conhecido como \ac{http}, como consequência, elaborou-se um protocolo
    próprio construido sobre o \ac{udp}. Sua dinamica se baseia em 

    %funcionamento geral/ estado do sistema

    %conclusão para ir à conclusão
