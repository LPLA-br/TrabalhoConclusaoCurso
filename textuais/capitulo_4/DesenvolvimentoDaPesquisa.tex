...
\section{\textbf{DESENVOLVIMENTO DA PESQUISA}}
    ...
    Em seguida, com problemas determinados, seguiu-se para a escolha de quais
    ...
    qualquer rede com acesso a internet, fora desenvolvido para redes de internet
    de amplo alcançe, conhecidas como WANs.

    Entretanto, viu-se que essa caracteristica de disponibilidade ampla não
    seria viável devido ao alto custo de infraestrutura de computadores
    em núvem e possíveis problemas legais decorrentes de vazamentos de dados
    ...
    à encontrada em aplicações anteriores à difusão da acessibilidade da
    internet.
    ...
    %php como linguagem.
    Conseguinte, prosseguiu-se na definição de uma linguagem de programação
    ...
    negligenciável pois ainda se encontra presente no cerne de muitas aplicações
    grandes legadas \cite{theRegisterPHPDecline}.

    %modelo de classes
    Definida a linguagem de programação de projeto proseguiu para a
    modelagem do esquema de classes do domínio de negócios. O domínio
    minunciosamente estudado consolidou as seguintes classes
