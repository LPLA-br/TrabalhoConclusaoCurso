...
\section{\textbf{DESENVOLVIMENTO}}
    ...
    confecções e consertos não monitorados.

    %aspectos não funcionais
    Em seguida, partiu-se para escolha das melhores ferramentas para o contexto
    desafiador que delineou-se a problemática. Começou, aqui, a etapa que avalia
    ...
    %php como linguagem.
    Por conseguinte, prosseguiu-se no emprego de uma linguagem de programação
    ...
    PHP; Python; Ruby; Rust; Go; entre outras. Entretanto, devido ao já largo
    emprego de Javascript, assumiu-se uma alternativa mais tradicional na
    forma da linguagem de programação PHP.
    ...
    domínio de negócios, onde o domínio minuciosamente estudado traz as
    ...
    Complementando o diagrama sobreposto, determina-se que a classe "serviço de costureira",
    elemento pivô, possui relação de composição de clientes que por sua vez
    agregam classes representantes de seus dados. Por outro lado, há classes
    ...
    Em questão de organização de diretórios e subdiretórios, convencionou-se a
    ...
    como peças e insumos possuissem excesso de responsabilidades na manipulação
    de matrizes de subobjetos agregados.
    ...
    %pgsql e sockets
    Duas extensões cujas as finalidades garantem as capacidades
    ...
    de consultas para instanciação de classes de domínio \ac{sql}.
    ...
    \begin{figure}[h]
      \centering
      \caption{ Exemplos de Comandos do Protocolo Ateliê. }
